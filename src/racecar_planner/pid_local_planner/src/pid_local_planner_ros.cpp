#include "pid_local_planner_ros.h"

#include <pluginlib/class_list_macros.h>

PLUGINLIB_EXPORT_CLASS(pid_local_planner::PidLocalPlannerROS, nav_core::BaseLocalPlanner)
 ...
 */
double PidLocalPlannerROS::getGoalPositionDistance(const geometry_msgs::PoseStamped& goal_ps, double x, double y)
{
